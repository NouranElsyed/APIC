// Minimal, dependency-free ZIP (store/no-compression) writer — used only to
// package multiple per-sheet DXF files into one download (PROJECT.md §31).
// Not a general-purpose zip library: local files, no compression, no
// directories, no unicode-flag handling beyond UTF-8 names. This is
// sufficient for CAD software and OS file explorers to open the archive.
...
// DOS date/time fields — fixed timestamp is fine, this is a generated
